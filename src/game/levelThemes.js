 ...
 *
 * Each theme controls:
 *  - Visual atmosphere: background, nebula fog, star tint, boss color
 *  - Gameplay feel: bullet speed/size multipliers
 *
 * nebulae: soft colored fog clouds positioned in the background.
 *   { x, y } are 0-1 fractions of screen size,
 *   radius is fraction of max(w,h), alpha is peak opacity.
 */
...
export const LEVELS = [
  {
    ...
    colors: {
      ...
      vignette: 0x1a0800,
      nebulae: [
        { x: 0.7, y: 0.3, radius: 0.4, color: 0xff6600, alpha: 0.06 },
        { x: 0.2, y: 0.7, radius: 0.3, color: 0xdd4400, alpha: 0.04 },
      ],
    },
    bossColor: 0xdd8844,
  ...
  },
  {
    ...
    colors: {
      ...
      vignette: 0x140e04,
      nebulae: [
        { x: 0.5, y: 0.4, radius: 0.5, color: 0xddaa33, alpha: 0.07 },
        { x: 0.8, y: 0.8, radius: 0.3, color: 0xcc8800, alpha: 0.05 },
      ],
    },
    bossColor: 0xddaa44,
  ...
  },
  {
    ...
    colors: {
      ...
      vignette: 0x061020,
      nebulae: [
        { x: 0.3, y: 0.5, radius: 0.4, color: 0x2266aa, alpha: 0.06 },
        { x: 0.7, y: 0.2, radius: 0.3, color: 0x22aa66, alpha: 0.04 },
      ],
    },
    bossColor: 0x4488cc,
  ...
  },
  {
    ...
    colors: {
      ...
      vignette: 0x0a0a18,
      nebulae: [
        { x: 0.5, y: 0.3, radius: 0.5, color: 0x8888cc, alpha: 0.05 },
        { x: 0.3, y: 0.7, radius: 0.35, color: 0xaaaadd, alpha: 0.04 },
      ],
    },
    bossColor: 0x9999cc,
  ...
  },
  {
    ...
    colors: {
      ...
      vignette: 0x200808,
      nebulae: [
        { x: 0.6, y: 0.4, radius: 0.45, color: 0xcc2200, alpha: 0.07 },
        { x: 0.2, y: 0.2, radius: 0.3, color: 0x882200, alpha: 0.05 },
      ],
    },
    bossColor: 0xcc4422,
  ...
  },
  {
    ...
    colors: {
      ...
      vignette: 0x140c04,
      nebulae: [
        { x: 0.4, y: 0.3, radius: 0.5, color: 0xcc7722, alpha: 0.08 },
        { x: 0.8, y: 0.6, radius: 0.35, color: 0x884411, alpha: 0.06 },
        { x: 0.15, y: 0.8, radius: 0.25, color: 0xdd9933, alpha: 0.04 },
      ],
    },
    bossColor: 0xcc8833,
  ...
  },
  {
    ...
    colors: {
      ...
      vignette: 0x121008,
      nebulae: [
        { x: 0.5, y: 0.35, radius: 0.45, color: 0xbbaa44, alpha: 0.06 },
        { x: 0.2, y: 0.6, radius: 0.3, color: 0x998833, alpha: 0.04 },
      ],
    },
    bossColor: 0xccaa44,
  ...
  },
  {
    ...
    colors: {
      ...
      vignette: 0x061418,
      nebulae: [
        { x: 0.5, y: 0.5, radius: 0.5, color: 0x0088aa, alpha: 0.08 },
        { x: 0.8, y: 0.2, radius: 0.3, color: 0x00aacc, alpha: 0.05 },
      ],
    },
    bossColor: 0x44aacc,
